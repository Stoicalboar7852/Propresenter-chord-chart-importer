...
class Action(_message.Message):
    ...
    class PlaylistItemType(_message.Message):
        ...
        def __init__(self, playlist_uuid: _Optional[_Union[_uuid_pb2.UUID, _Mapping]] = ..., playlist_name: _Optional[str] = ..., item_uuid: _Optional[_Union[_uuid_pb2.UUID, _Mapping]] = ..., item_name: _Optional[str] = ..., select_playlist: _Optional[bool] = ..., always_retrigger: _Optional[bool] = ...) -> None: ...
    ...
    class MediaType(_message.Message):
        ...
        class Video(_message.Message):
            ...
            def __init__(self, playback_behavior: _Optional[_Union[Action.MediaType.PlaybackBehavior, str]] = ..., end_behavior: _Optional[_Union[Action.MediaType.EndBehavior, str]] = ..., loop_time: _Optional[float] = ..., times_to_loop: _Optional[int] = ..., soft_loop: _Optional[bool] = ..., soft_loop_duration: _Optional[float] = ...) -> None: ...
    ...
    class PropType(_message.Message):
        __slots__ = ("identification", "trigger", "clear")
        class PropTrigger(_message.Message):
            __slots__ = ("auto_clear_enabled", "auto_clear_follows_prop_duration", "auto_clear_duration")
            AUTO_CLEAR_ENABLED_FIELD_NUMBER: _ClassVar[int]
            AUTO_CLEAR_FOLLOWS_PROP_DURATION_FIELD_NUMBER: _ClassVar[int]
            AUTO_CLEAR_DURATION_FIELD_NUMBER: _ClassVar[int]
            auto_clear_enabled: bool
            auto_clear_follows_prop_duration: bool
            auto_clear_duration: float
            def __init__(self, auto_clear_enabled: _Optional[bool] = ..., auto_clear_follows_prop_duration: _Optional[bool] = ..., auto_clear_duration: _Optional[float] = ...) -> None: ...
        class PropClear(_message.Message):
            __slots__ = ()
            def __init__(self) -> None: ...
        IDENTIFICATION_FIELD_NUMBER: _ClassVar[int]
        ...
        identification: _collectionElementType_pb2.CollectionElementType
        trigger: Action.PropType.PropTrigger
        clear: Action.PropType.PropClear
        def __init__(self, identification: _Optional[_Union[_collectionElementType_pb2.CollectionElementType, _Mapping]] = ..., trigger: _Optional[_Union[Action.PropType.PropTrigger, _Mapping]] = ..., clear: _Optional[_Union[Action.PropType.PropClear, _Mapping]] = ...) -> None: ...
    ...
    class AudioInputType(_message.Message):
        ...
        volume: float
        def __init__(self, index: _Optional[int] = ..., override_mode: _Optional[bool] = ..., behavior_mode: _Optional[_Union[_input_pb2.AudioInput.BehaviorMode, _Mapping]] = ..., override_volume: _Optional[bool] = ..., volume: _Optional[float] = ...) -> None: ...
    ...
    class CaptureType(_message.Message):
        ...
        class CaptureStop(_message.Message):
            ...
            def __init__(self, shows_alert_before_stopping: _Optional[bool] = ...) -> None: ...
