...
class ClearGroupsDocument(_message.Message):
    ...
    class ClearGroup(_message.Message):
        ...
        def __init__(self, uuid: _Optional[_Union[_uuid_pb2.UUID, _Mapping]] = ..., name: _Optional[str] = ..., layer_targets: _Optional[_Iterable[_Union[_action_pb2.Action.ClearType, _Mapping]]] = ..., is_hidden_in_preview: _Optional[bool] = ..., image_data: _Optional[bytes] = ..., image_type: _Optional[_Union[ClearGroupsDocument.ClearGroup.ImageType, str]] = ..., is_icon_tinted: _Optional[bool] = ..., icon_tint_color: _Optional[_Union[_color_pb2.Color, _Mapping]] = ..., timeline_targets: _Optional[_Iterable[_Union[_action_pb2.Action.ContentDestination, str]]] = ..., clear_presentation_next_slide: _Optional[bool] = ...) -> None: ...
