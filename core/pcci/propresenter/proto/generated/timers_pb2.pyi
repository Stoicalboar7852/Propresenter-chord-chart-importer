...
class Clock(_message.Message):
    ...
    class Format(_message.Message):
        ...
        def __init__(self, date_type: _Optional[_Union[Clock.Format.DateFormatterStyle, str]] = ..., time_format: _Optional[_Union[Clock.Format.DateFormatterStyle, str]] = ..., military_time_enabled: _Optional[bool] = ...) -> None: ...
...
class Timer(_message.Message):
    ...
    class Format(_message.Message):
        ...
        class Style(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
            __slots__ = ()
            STYLE_NONE: _ClassVar[Timer.Format.Style]
        ...
        def __init__(self, hour: _Optional[_Union[Timer.Format.Style, str]] = ..., minute: _Optional[_Union[Timer.Format.Style, str]] = ..., second: _Optional[_Union[Timer.Format.Style, str]] = ..., millisecond: _Optional[_Union[Timer.Format.Style, str]] = ..., is_wall_clock_time: _Optional[bool] = ..., is_24_hour_time: _Optional[bool] = ..., show_milliseconds_under_minute_only: _Optional[bool] = ...) -> None: ...
    class Configuration(_message.Message):
        ...
        class TimerTypeElapsedTime(_message.Message):
            ...
            end_time: float
            has_end_time: bool
            def __init__(self, start_time: _Optional[float] = ..., end_time: _Optional[float] = ..., has_end_time: _Optional[bool] = ...) -> None: ...
        ...
        def __init__(self, allows_overrun: _Optional[bool] = ..., countdown: _Optional[_Union[Timer.Configuration.TimerTypeCountdown, _Mapping]] = ..., countdown_to_time: _Optional[_Union[Timer.Configuration.TimerTypeCountdownToTime, _Mapping]] = ..., elapsed_time: _Optional[_Union[Timer.Configuration.TimerTypeElapsedTime, _Mapping]] = ...) -> None: ...
...
class LocalTimer(_message.Message):
    __slots__ = ("uuid", "configuration")
    UUID_FIELD_NUMBER: _ClassVar[int]
    CONFIGURATION_FIELD_NUMBER: _ClassVar[int]
    uuid: _uuid_pb2.UUID
    configuration: Timer.Configuration
    def __init__(self, uuid: _Optional[_Union[_uuid_pb2.UUID, _Mapping]] = ..., configuration: _Optional[_Union[Timer.Configuration, _Mapping]] = ...) -> None: ...

class TimersLocalDocument(_message.Message):
    __slots__ = ("timers",)
    TIMERS_FIELD_NUMBER: _ClassVar[int]
    timers: _containers.RepeatedCompositeFieldContainer[LocalTimer]
    def __init__(self, timers: _Optional[_Iterable[_Union[LocalTimer, _Mapping]]] = ...) -> None: ...
