...
class Workspace(_message.Message):
    ...
    class EditorBackground(_message.Message):
        ...
        url: _url_pb2.URL
        opacity: float
        def __init__(self, enabled: _Optional[bool] = ..., frame: _Optional[_Union[_graphicsData_pb2.Graphics.Rect, _Mapping]] = ..., url: _Optional[_Union[_url_pb2.URL, _Mapping]] = ..., opacity: _Optional[float] = ...) -> None: ...
