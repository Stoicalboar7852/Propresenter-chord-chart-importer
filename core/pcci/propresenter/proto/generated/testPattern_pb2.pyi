...
class TestPattern(_message.Message):
    ...
    class BlendGrid(_message.Message):
        ...
        invert_colors: bool
        grid_spacing: float
        def __init__(self, draw_grid: _Optional[bool] = ..., draw_circles: _Optional[bool] = ..., draw_lines: _Optional[bool] = ..., invert_colors: _Optional[bool] = ..., grid_spacing: _Optional[float] = ...) -> None: ...
...
class TestPatternDefinition(_message.Message):
    ...
    class ColorProperty(_message.Message):
        ...
        def __init__(self, value: _Optional[_Union[_color_pb2.Color, _Mapping]] = ..., allow_alpha: _Optional[bool] = ..., default_colors: _Optional[_Iterable[_Union[_color_pb2.Color, _Mapping]]] = ...) -> None: ...
    ...
    class BoolProperty(_message.Message):
        ...
        def __init__(self, value: _Optional[bool] = ..., dependent_properties: _Optional[_Iterable[_Union[TestPatternDefinition.Property, _Mapping]]] = ...) -> None: ...
    ...
    is_default: bool
    def __init__(self, uuid: _Optional[_Union[_uuid_pb2.UUID, _Mapping]] = ..., name_localization_key: _Optional[str] = ..., properties: _Optional[_Iterable[_Union[TestPatternDefinition.Property, _Mapping]]] = ..., show_delay_settings: _Optional[bool] = ..., is_default: _Optional[bool] = ...) -> None: ...
...
class TestPatternState(_message.Message):
    ...
    def __init__(self, pattern: _Optional[_Union[TestPatternDefinition, _Mapping]] = ..., show_pattern: _Optional[bool] = ..., display_location: _Optional[_Union[TestPatternState.DisplayLocation, str]] = ..., specific_screen: _Optional[_Union[_uuid_pb2.UUID, _Mapping]] = ..., identify_screens: _Optional[bool] = ..., logo_type: _Optional[_Union[LogoType, str]] = ..., user_logo_location: _Optional[_Union[_url_pb2.URL, _Mapping]] = ...) -> None: ...
...
class TestPatternDocument(_message.Message):
    ...
    class TestPatternData(_message.Message):
        ...
        class BoolProperty(_message.Message):
            ...
            def __init__(self, value: _Optional[bool] = ..., dependent_properties: _Optional[_Iterable[_Union[TestPatternDocument.TestPatternData.Property, _Mapping]]] = ...) -> None: ...
        class StringProperty(_message.Message):
            __slots__ = ("value",)
            VALUE_FIELD_NUMBER: _ClassVar[int]
            value: str
