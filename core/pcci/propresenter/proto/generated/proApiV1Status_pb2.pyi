...
class API_v1_Status_Response(_message.Message):
    ...
    class GetLayers(_message.Message):
        ...
        messages: bool
        audio: bool
        def __init__(self, video_input: _Optional[bool] = ..., media: _Optional[bool] = ..., slide: _Optional[bool] = ..., announcements: _Optional[bool] = ..., props: _Optional[bool] = ..., messages: _Optional[bool] = ..., audio: _Optional[bool] = ...) -> None: ...
    class GetStageScreens(_message.Message):
        __slots__ = ("enabled",)
        ENABLED_FIELD_NUMBER: _ClassVar[int]
        enabled: bool
