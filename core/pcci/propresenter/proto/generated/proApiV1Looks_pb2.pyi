...
class API_v1_Screen(_message.Message):
    ...
    presentation: str
    mask: str
    def __init__(self, video_input: _Optional[bool] = ..., media: _Optional[bool] = ..., slide: _Optional[bool] = ..., announcements: _Optional[bool] = ..., props: _Optional[bool] = ..., messages: _Optional[bool] = ..., presentation: _Optional[str] = ..., mask: _Optional[str] = ...) -> None: ...
