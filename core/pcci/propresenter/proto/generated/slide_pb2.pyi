...
class Slide(_message.Message):
    ...
    class Element(_message.Message):
        ...
        class DataLink(_message.Message):
            __slots__ = ("ticker", "alternate_text", "timer_text", "clock_text", "chord_chart", "output_screen", "pco_live", "alternate_fill", "visibility_link", "slide_text", "stage_message", "video_countdown", "slide_image", "ccli_text", "group_name", "group_color", "presentation_notes", "playlist_item", "auto_advance_time_remaining", "capture_status_text", "capture_status_color", "slide_count", "audio_countdown", "presentation", "slide_Label_Text", "slide_Label_Color", "rss_feed", "file_feed", "chord_pro_chart", "playback_marker_text", "playback_marker_color", "timecode_text", "timecode_status", "message_text", "key_value_text", "key_value_fill", "zone")
            ...
            class Ticker(_message.Message):
                ...
                def __init__(self, play_rate: _Optional[float] = ..., should_loop: _Optional[bool] = ..., loop_delay: _Optional[float] = ..., text_delimiter: _Optional[str] = ..., text_type: _Optional[_Union[Slide.Element.DataLink.Ticker.TextType, _Mapping]] = ..., rss_type: _Optional[_Union[Slide.Element.DataLink.Ticker.RSSType, _Mapping]] = ..., file_type: _Optional[_Union[Slide.Element.DataLink.Ticker.FileType, _Mapping]] = ...) -> None: ...
            ...
            class SlideText(_message.Message):
                ...
                def __init__(self, source_slide: _Optional[_Union[Slide.Element.DataLink.SlideSourceType, str]] = ..., source_option: _Optional[_Union[Slide.Element.DataLink.SlideText.TextSourceOption, str]] = ..., preserve_notes_format: _Optional[bool] = ..., name_to_match: _Optional[str] = ..., element_text_transform: _Optional[_Union[Slide.Element.DataLink.AlternateElementText.TextTransformOption, str]] = ...) -> None: ...
            ...
            class StageMessage(_message.Message):
                ...
                def __init__(self, should_flash: _Optional[bool] = ..., flash_color: _Optional[_Union[_color_pb2.Color, _Mapping]] = ...) -> None: ...
            class VideoCountdown(_message.Message):
                ...
                def __init__(self, timer_format: _Optional[_Union[_timers_pb2.Timer.Format, _Mapping]] = ..., timer_format_string: _Optional[str] = ..., color_triggers: _Optional[_Iterable[_Union[Slide.Element.DataLink.ColorTrigger, _Mapping]]] = ..., ignore_looping_videos: _Optional[bool] = ..., video_countdown_source: _Optional[_Union[Slide.Element.DataLink.VideoCountdown.VideoCountdownSource, str]] = ...) -> None: ...
            class AudioCountdown(_message.Message):
                ...
                def __init__(self, timer_format: _Optional[_Union[_timers_pb2.Timer.Format, _Mapping]] = ..., timer_format_string: _Optional[str] = ..., color_triggers: _Optional[_Iterable[_Union[Slide.Element.DataLink.ColorTrigger, _Mapping]]] = ..., ignore_looping_audio: _Optional[bool] = ...) -> None: ...
            ...
            class PlaylistItem(_message.Message):
                ...
                def __init__(self, playlistItemSource: _Optional[_Union[Slide.Element.DataLink.PlaylistItem.PlaylistItemSourceType, str]] = ..., showArrangement: _Optional[bool] = ...) -> None: ...
            ...
            class PlaybackMarkerText(_message.Message):
                ...
                def __init__(self, identifier: _Optional[_Union[Slide.Element.DataLink.PlaybackMarkerIdentifier, _Mapping]] = ..., should_use_marker_color: _Optional[bool] = ..., name: _Optional[_Union[Slide.Element.DataLink.PlaybackMarkerText.Name, _Mapping]] = ..., time: _Optional[_Union[Slide.Element.DataLink.PlaybackMarkerText.Time, _Mapping]] = ...) -> None: ...
            ...
            class TimecodeStatus(_message.Message):
                __slots__ = ()
                def __init__(self) -> None: ...
            class KeyValueText(_message.Message):
                __slots__ = ("key",)
                KEY_FIELD_NUMBER: _ClassVar[int]
                key: str
                def __init__(self, key: _Optional[str] = ...) -> None: ...
            class KeyValueFill(_message.Message):
                __slots__ = ("key",)
                KEY_FIELD_NUMBER: _ClassVar[int]
                key: str
                def __init__(self, key: _Optional[str] = ...) -> None: ...
            ...
            KEY_VALUE_TEXT_FIELD_NUMBER: _ClassVar[int]
            KEY_VALUE_FILL_FIELD_NUMBER: _ClassVar[int]
        ...
        class TextScroller(_message.Message):
            ...
            fade_left: float
            fade_right: float
            def __init__(self, should_scroll: _Optional[bool] = ..., scroll_rate: _Optional[float] = ..., should_repeat: _Optional[bool] = ..., repeat_distance: _Optional[float] = ..., scrolling_direction: _Optional[_Union[Slide.Element.TextScroller.Direction, str]] = ..., starts_off_screen: _Optional[bool] = ..., fade_left: _Optional[float] = ..., fade_right: _Optional[float] = ...) -> None: ...
