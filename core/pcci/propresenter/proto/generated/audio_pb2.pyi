...
class Audio(_message.Message):
    ...
    class SettingsDocument(_message.Message):
        ...
        def __init__(self, output_setup: _Optional[_Union[Audio.OutputSetup, _Mapping]] = ..., monitor_device: _Optional[_Union[Audio.Device, _Mapping]] = ..., monitor_on_mains: _Optional[bool] = ...) -> None: ...
    ...
    class LogicalChannel(_message.Message):
        ...
        class OutputChannel(_message.Message):
            ...
            solo: bool
            test_tone: bool
            def __init__(self, index: _Optional[int] = ..., muted: _Optional[bool] = ..., solo: _Optional[bool] = ..., test_tone: _Optional[bool] = ...) -> None: ...
        UUID_FIELD_NUMBER: _ClassVar[int]
        NAME_FIELD_NUMBER: _ClassVar[int]
        INDEX_FIELD_NUMBER: _ClassVar[int]
        MUTED_FIELD_NUMBER: _ClassVar[int]
        ...
        solo: bool
        test_tone: bool
        def __init__(self, uuid: _Optional[_Union[_uuid_pb2.UUID, _Mapping]] = ..., name: _Optional[str] = ..., index: _Optional[int] = ..., muted: _Optional[bool] = ..., physical_audio_channels: _Optional[_Iterable[_Union[Audio.LogicalChannel.OutputChannel, _Mapping]]] = ..., solo: _Optional[bool] = ..., test_tone: _Optional[bool] = ...) -> None: ...
    class PhysicalChannel(_message.Message):
        ...
        solo_enable: bool
        tone_enable: bool
        def __init__(self, index: _Optional[int] = ..., mute_enable: _Optional[bool] = ..., solo_enable: _Optional[bool] = ..., tone_enable: _Optional[bool] = ...) -> None: ...
