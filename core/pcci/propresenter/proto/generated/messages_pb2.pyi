...
class Message(_message.Message):
    ...
    def __init__(self, uuid: _Optional[_Union[_uuid_pb2.UUID, _Mapping]] = ..., title: _Optional[str] = ..., time_to_remove: _Optional[float] = ..., visible_on_network: _Optional[bool] = ..., template: _Optional[_Union[_templateIdentification_pb2.TemplateIdentification, _Mapping]] = ..., clear_type: _Optional[_Union[Message.ClearType, str]] = ..., message_text: _Optional[str] = ..., tokens: _Optional[_Iterable[_Union[Message.Token, _Mapping]]] = ..., token_values: _Optional[_Iterable[_Union[Message.TokenValue, _Mapping]]] = ...) -> None: ...
...
class LocalMessage(_message.Message):
    __slots__ = ("uuid", "token_values")
    UUID_FIELD_NUMBER: _ClassVar[int]
    TOKEN_VALUES_FIELD_NUMBER: _ClassVar[int]
    uuid: _uuid_pb2.UUID
    token_values: _containers.RepeatedCompositeFieldContainer[Message.TokenValue]
    def __init__(self, uuid: _Optional[_Union[_uuid_pb2.UUID, _Mapping]] = ..., token_values: _Optional[_Iterable[_Union[Message.TokenValue, _Mapping]]] = ...) -> None: ...

class MessageLocalDocument(_message.Message):
    __slots__ = ("messages",)
    MESSAGES_FIELD_NUMBER: _ClassVar[int]
    messages: _containers.RepeatedCompositeFieldContainer[LocalMessage]
    def __init__(self, messages: _Optional[_Iterable[_Union[LocalMessage, _Mapping]]] = ...) -> None: ...
