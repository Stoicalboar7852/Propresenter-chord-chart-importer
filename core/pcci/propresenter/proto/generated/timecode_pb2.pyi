...
class TimecodeSettings(_message.Message):
    ...
    is_active: bool
    def __init__(self, device_identifier: _Optional[str] = ..., channel: _Optional[int] = ..., format: _Optional[_Union[TimecodeSettings.Format, str]] = ..., offset: _Optional[float] = ..., playlist_identifier: _Optional[_Union[_uuid_pb2.UUID, _Mapping]] = ..., is_active: _Optional[bool] = ...) -> None: ...
