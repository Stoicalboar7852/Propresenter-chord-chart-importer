...
class Presentation(_message.Message):
    ...
    class CCLI(_message.Message):
        ...
        album: str
        artwork: bytes
        def __init__(self, author: _Optional[str] = ..., artist_credits: _Optional[str] = ..., song_title: _Optional[str] = ..., publisher: _Optional[str] = ..., copyright_year: _Optional[int] = ..., song_number: _Optional[int] = ..., display: _Optional[bool] = ..., album: _Optional[str] = ..., artwork: _Optional[bytes] = ...) -> None: ...
    ...
    class Timeline(_message.Message):
        ...
        def __init__(self, cues: _Optional[_Iterable[_Union[Presentation.Timeline.Cue, _Mapping]]] = ..., duration: _Optional[float] = ..., loop: _Optional[bool] = ..., audio_action: _Optional[_Union[_action_pb2.Action, _Mapping]] = ..., timecode_enable: _Optional[bool] = ..., timecode_offset: _Optional[float] = ..., cues_v2: _Optional[_Iterable[_Union[Presentation.Timeline.Cue, _Mapping]]] = ...) -> None: ...
