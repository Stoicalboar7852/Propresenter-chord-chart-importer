...
class ProPresenterWorkspace(_message.Message):
    __slots__ = ("pro_screens", "audience_looks", "live_audience_look", "masks", "videoInputs", "stage_layout_mappings", "audio_settings", "selected_library_name", "record_settings", "digital_audio_setup", "audio_inputs", "audio_input_transition_time", "cloud_output_screens", "cloud_video_inputs", "cloud_audio_inputs", "audio_channel_count")
    ...
    CLOUD_OUTPUT_SCREENS_FIELD_NUMBER: _ClassVar[int]
    CLOUD_VIDEO_INPUTS_FIELD_NUMBER: _ClassVar[int]
    CLOUD_AUDIO_INPUTS_FIELD_NUMBER: _ClassVar[int]
    ...
    cloud_output_screens: _containers.RepeatedCompositeFieldContainer[_proscreen_pb2.CloudProPresenterScreen]
    cloud_video_inputs: _containers.RepeatedCompositeFieldContainer[_input_pb2.CloudVideoInput]
    cloud_audio_inputs: _containers.RepeatedCompositeFieldContainer[_input_pb2.CloudAudioInput]
    audio_channel_count: int
    def __init__(self, pro_screens: _Optional[_Iterable[_Union[_proscreen_pb2.ProPresenterScreen, _Mapping]]] = ..., audience_looks: _Optional[_Iterable[_Union[_proAudienceLook_pb2.ProAudienceLook, _Mapping]]] = ..., live_audience_look: _Optional[_Union[_proAudienceLook_pb2.ProAudienceLook, _Mapping]] = ..., masks: _Optional[_Iterable[_Union[_proMask_pb2.ProMask, _Mapping]]] = ..., videoInputs: _Optional[_Iterable[_Union[_input_pb2.VideoInput, _Mapping]]] = ..., stage_layout_mappings: _Optional[_Iterable[_Union[_stage_pb2.Stage.ScreenAssignment, _Mapping]]] = ..., audio_settings: _Optional[_Union[_audio_pb2.Audio.SettingsDocument, _Mapping]] = ..., selected_library_name: _Optional[str] = ..., record_settings: _Optional[_Union[_recording_pb2.Recording.SettingsDocument, _Mapping]] = ..., digital_audio_setup: _Optional[_Union[_digitalAudio_pb2.DigitalAudio.Setup, _Mapping]] = ..., audio_inputs: _Optional[_Iterable[_Union[_input_pb2.AudioInput, _Mapping]]] = ..., audio_input_transition_time: _Optional[float] = ..., cloud_output_screens: _Optional[_Iterable[_Union[_proscreen_pb2.CloudProPresenterScreen, _Mapping]]] = ..., cloud_video_inputs: _Optional[_Iterable[_Union[_input_pb2.CloudVideoInput, _Mapping]]] = ..., cloud_audio_inputs: _Optional[_Iterable[_Union[_input_pb2.CloudAudioInput, _Mapping]]] = ..., audio_channel_count: _Optional[int] = ...) -> None: ...

class ProPresenterLocalWorkspace(_message.Message):
    __slots__ = ("digital_audio_setup", "pro_screens", "video_inputs", "audio_inputs", "live_audience_look", "stage_layout_mappings")
    DIGITAL_AUDIO_SETUP_FIELD_NUMBER: _ClassVar[int]
    PRO_SCREENS_FIELD_NUMBER: _ClassVar[int]
    VIDEO_INPUTS_FIELD_NUMBER: _ClassVar[int]
    AUDIO_INPUTS_FIELD_NUMBER: _ClassVar[int]
    LIVE_AUDIENCE_LOOK_FIELD_NUMBER: _ClassVar[int]
    STAGE_LAYOUT_MAPPINGS_FIELD_NUMBER: _ClassVar[int]
    digital_audio_setup: _digitalAudio_pb2.DigitalAudio.Setup
    pro_screens: _containers.RepeatedCompositeFieldContainer[_proscreen_pb2.ProPresenterScreen]
    video_inputs: _containers.RepeatedCompositeFieldContainer[_input_pb2.VideoInput]
    audio_inputs: _containers.RepeatedCompositeFieldContainer[_input_pb2.AudioInput]
    live_audience_look: _proAudienceLook_pb2.ProAudienceLook
    stage_layout_mappings: _containers.RepeatedCompositeFieldContainer[_stage_pb2.Stage.ScreenAssignment]
    def __init__(self, digital_audio_setup: _Optional[_Union[_digitalAudio_pb2.DigitalAudio.Setup, _Mapping]] = ..., pro_screens: _Optional[_Iterable[_Union[_proscreen_pb2.ProPresenterScreen, _Mapping]]] = ..., video_inputs: _Optional[_Iterable[_Union[_input_pb2.VideoInput, _Mapping]]] = ..., audio_inputs: _Optional[_Iterable[_Union[_input_pb2.AudioInput, _Mapping]]] = ..., live_audience_look: _Optional[_Union[_proAudienceLook_pb2.ProAudienceLook, _Mapping]] = ..., stage_layout_mappings: _Optional[_Iterable[_Union[_stage_pb2.Stage.ScreenAssignment, _Mapping]]] = ...) -> None: ...
