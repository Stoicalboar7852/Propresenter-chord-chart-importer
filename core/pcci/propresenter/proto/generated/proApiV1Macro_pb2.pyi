...
class API_v1_Macro(_message.Message):
    __slots__ = ("id", "color", "image_type", "actions")
    ...
    image_type: str
    actions: _containers.RepeatedCompositeFieldContainer[API_v1_MacroAction]
    def __init__(self, id: _Optional[_Union[_proApiV1Identifier_pb2.API_v1_Identifier, _Mapping]] = ..., color: _Optional[_Union[_proApiV1Color_pb2.API_v1_Color, _Mapping]] = ..., image_type: _Optional[str] = ..., actions: _Optional[_Iterable[_Union[API_v1_MacroAction, _Mapping]]] = ...) -> None: ...

class API_v1_MacroAction(_message.Message):
    __slots__ = ("type",)
