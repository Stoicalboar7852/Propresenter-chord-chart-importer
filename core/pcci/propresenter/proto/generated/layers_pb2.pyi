...
class Layer(_message.Message):
    ...
    class Blending(_message.Message):
        ...
        class Matte(_message.Message):
            ...
            class Alpha(_message.Message):
                ...
                inverted: bool
                def __init__(self, inverted: _Optional[bool] = ...) -> None: ...
    ...
    def __init__(self, uuid: _Optional[_Union[_uuid_pb2.UUID, _Mapping]] = ..., name: _Optional[str] = ..., color: _Optional[_Union[_color_pb2.Color, _Mapping]] = ..., muted: _Optional[bool] = ..., hidden: _Optional[bool] = ..., blend_mode: _Optional[_Union[Layer.BlendMode, str]] = ..., opacity: _Optional[float] = ..., selected_target_set_uuid: _Optional[_Union[_uuid_pb2.UUID, _Mapping]] = ..., effects_preset_uuid: _Optional[_Union[_uuid_pb2.UUID, _Mapping]] = ..., effects_build_duration: _Optional[float] = ..., layer_preset_uuid: _Optional[_Union[_uuid_pb2.UUID, _Mapping]] = ..., hot_key: _Optional[_Union[_hotKey_pb2.HotKey, _Mapping]] = ..., transition: _Optional[_Union[_effects_pb2.Transition, _Mapping]] = ..., effects: _Optional[_Iterable[_Union[_effects_pb2.Effect, _Mapping]]] = ..., blend: _Optional[_Union[Layer.Blending, _Mapping]] = ...) -> None: ...
