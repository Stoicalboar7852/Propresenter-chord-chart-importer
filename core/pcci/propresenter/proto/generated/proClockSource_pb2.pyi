...
class ProClockSource(_message.Message):
    ...
    def __init__(self, uuid: _Optional[str] = ..., name: _Optional[str] = ..., connected: _Optional[bool] = ..., active: _Optional[bool] = ..., type: _Optional[_Union[ProClockSource.Type, str]] = ...) -> None: ...
