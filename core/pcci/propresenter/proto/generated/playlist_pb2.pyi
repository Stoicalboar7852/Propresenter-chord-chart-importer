...
class Playlist(_message.Message):
    ...
    class StartupInfo(_message.Message):
        ...
        def __init__(self, trigger_on_startup: _Optional[bool] = ...) -> None: ...
    UUID_FIELD_NUMBER: _ClassVar[int]
    NAME_FIELD_NUMBER: _ClassVar[int]
    ...
    def __init__(self, uuid: _Optional[_Union[_uuid_pb2.UUID, _Mapping]] = ..., name: _Optional[str] = ..., type: _Optional[_Union[Playlist.Type, str]] = ..., expanded: _Optional[bool] = ..., targeted_layer_uuid: _Optional[_Union[_uuid_pb2.UUID, _Mapping]] = ..., smart_directory_path: _Optional[_Union[_url_pb2.URL, _Mapping]] = ..., hot_key: _Optional[_Union[_hotKey_pb2.HotKey, _Mapping]] = ..., cues: _Optional[_Iterable[_Union[_cue_pb2.Cue, _Mapping]]] = ..., children: _Optional[_Iterable[_Union[Playlist, _Mapping]]] = ..., timecode_enabled: _Optional[bool] = ..., timing: _Optional[_Union[Playlist.TimingType, str]] = ..., startup_info: _Optional[_Union[Playlist.StartupInfo, _Mapping]] = ..., playlists: _Optional[_Union[Playlist.PlaylistArray, _Mapping]] = ..., items: _Optional[_Union[Playlist.PlaylistItems, _Mapping]] = ..., smart_directory: _Optional[_Union[Playlist.FolderDirectory, _Mapping]] = ..., pco_plan: _Optional[_Union[_planningCenter_pb2.PlanningCenterPlan, _Mapping]] = ...) -> None: ...
...
class PlaylistItem(_message.Message):
    ...
    class Presentation(_message.Message):
        __slots__ = ("document_path", "arrangement", "content_destination", "user_music_key", "arrangement_name")
        ...
        def __init__(self, document_path: _Optional[_Union[_url_pb2.URL, _Mapping]] = ..., arrangement: _Optional[_Union[_uuid_pb2.UUID, _Mapping]] = ..., content_destination: _Optional[_Union[_action_pb2.Action.ContentDestination, str]] = ..., user_music_key: _Optional[_Union[_musicKeyScale_pb2.MusicKeyScale, _Mapping]] = ..., arrangement_name: _Optional[str] = ...) -> None: ...
