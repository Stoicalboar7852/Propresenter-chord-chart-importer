...
class MacrosDocument(_message.Message):
    ...
    class MacroCollection(_message.Message):
        ...
        def __init__(self, uuid: _Optional[_Union[_uuid_pb2.UUID, _Mapping]] = ..., name: _Optional[str] = ..., items: _Optional[_Iterable[_Union[MacrosDocument.MacroCollection.Item, _Mapping]]] = ..., macros: _Optional[_Iterable[_Union[MacrosDocument.Macro, _Mapping]]] = ...) -> None: ...
