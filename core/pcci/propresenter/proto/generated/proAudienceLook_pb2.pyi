...
class ProAudienceLook(_message.Message):
    ...
    class ProScreenLook(_message.Message):
        ...
        def __init__(self, pro_screen_uuid: _Optional[_Union[_uuid_pb2.UUID, _Mapping]] = ..., props_enabled: _Optional[bool] = ..., live_video_enabled: _Optional[bool] = ..., presentation_background_enabled: _Optional[bool] = ..., template_document_file_path: _Optional[_Union[_url_pb2.URL, _Mapping]] = ..., template_slide_uuid: _Optional[_Union[_uuid_pb2.UUID, _Mapping]] = ..., presentation_foreground_enabled: _Optional[bool] = ..., mask_uuid: _Optional[_Union[_uuid_pb2.UUID, _Mapping]] = ..., announcements_enabled: _Optional[bool] = ..., props_layer_enabled: _Optional[bool] = ..., messages_layer_enabled: _Optional[bool] = ...) -> None: ...
