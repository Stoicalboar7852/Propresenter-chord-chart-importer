...
class API_v1_ClearGroup(_message.Message):
    ...
    def __init__(self, id: _Optional[_Union[_proApiV1Identifier_pb2.API_v1_Identifier, _Mapping]] = ..., icon: _Optional[str] = ..., tint: _Optional[_Union[_proApiV1Color_pb2.API_v1_Color, _Mapping]] = ..., layers: _Optional[_Iterable[_Union[API_v1_ClearGroup.API_v1_ClearGroupLayerType, str]]] = ..., stop_timeline_announcements: _Optional[bool] = ..., stop_timeline_presentation: _Optional[bool] = ..., clear_next_presentation: _Optional[bool] = ...) -> None: ...
