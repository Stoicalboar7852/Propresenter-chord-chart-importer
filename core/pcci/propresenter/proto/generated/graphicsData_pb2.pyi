...
class Graphics(_message.Message):
    ...
    class Element(_message.Message):
        ...
        def __init__(self, uuid: _Optional[_Union[_uuid_pb2.UUID, _Mapping]] = ..., name: _Optional[str] = ..., bounds: _Optional[_Union[Graphics.Rect, _Mapping]] = ..., rotation: _Optional[float] = ..., opacity: _Optional[float] = ..., locked: _Optional[bool] = ..., aspect_ratio_locked: _Optional[bool] = ..., path: _Optional[_Union[Graphics.Path, _Mapping]] = ..., fill: _Optional[_Union[Graphics.Fill, _Mapping]] = ..., stroke: _Optional[_Union[Graphics.Stroke, _Mapping]] = ..., shadow: _Optional[_Union[Graphics.Shadow, _Mapping]] = ..., feather: _Optional[_Union[Graphics.Feather, _Mapping]] = ..., text: _Optional[_Union[Graphics.Text, _Mapping]] = ..., flipMode: _Optional[_Union[Graphics.Element.FlipMode, str]] = ..., hidden: _Optional[bool] = ..., text_line_mask: _Optional[_Union[Graphics.Text.LineFillMask, _Mapping]] = ...) -> None: ...
    ...
    class Path(_message.Message):
        ...
        class BezierPoint(_message.Message):
            ...
            q1: Graphics.Point
            curved: bool
            def __init__(self, point: _Optional[_Union[Graphics.Point, _Mapping]] = ..., q0: _Optional[_Union[Graphics.Point, _Mapping]] = ..., q1: _Optional[_Union[Graphics.Point, _Mapping]] = ..., curved: _Optional[bool] = ...) -> None: ...
        ...
        def __init__(self, closed: _Optional[bool] = ..., points: _Optional[_Iterable[_Union[Graphics.Path.BezierPoint, _Mapping]]] = ..., shape: _Optional[_Union[Graphics.Path.Shape, _Mapping]] = ...) -> None: ...
    class Fill(_message.Message):
        ...
        def __init__(self, enable: _Optional[bool] = ..., color: _Optional[_Union[_color_pb2.Color, _Mapping]] = ..., gradient: _Optional[_Union[Graphics.Gradient, _Mapping]] = ..., media: _Optional[_Union[Media, _Mapping]] = ..., backgroundEffect: _Optional[_Union[Graphics.BackgroundEffect, _Mapping]] = ...) -> None: ...
    ...
    class Shadow(_message.Message):
        ...
        opacity: float
        enable: bool
        def __init__(self, style: _Optional[_Union[Graphics.Shadow.Style, str]] = ..., angle: _Optional[float] = ..., offset: _Optional[float] = ..., radius: _Optional[float] = ..., color: _Optional[_Union[_color_pb2.Color, _Mapping]] = ..., opacity: _Optional[float] = ..., enable: _Optional[bool] = ...) -> None: ...
    class Stroke(_message.Message):
        ...
        enable: bool
        def __init__(self, style: _Optional[_Union[Graphics.Stroke.Style, str]] = ..., width: _Optional[float] = ..., color: _Optional[_Union[_color_pb2.Color, _Mapping]] = ..., pattern: _Optional[_Iterable[float]] = ..., enable: _Optional[bool] = ...) -> None: ...
    class Feather(_message.Message):
        ...
        radius: float
        enable: bool
        def __init__(self, style: _Optional[_Union[Graphics.Feather.Style, str]] = ..., radius: _Optional[float] = ..., enable: _Optional[bool] = ...) -> None: ...
    class Text(_message.Message):
        __slots__ = ("attributes", "shadow", "rtf_data", "vertical_alignment", "scale_behavior", "margins", "is_superscript_standardized", "transform", "transformDelimiter", "chord_pro", "alternate_texts")
        ...
        class LineFillMask(_message.Message):
            ...
            def __init__(self, enabled: _Optional[bool] = ..., height_offset: _Optional[float] = ..., vertical_offset: _Optional[float] = ..., mask_style: _Optional[_Union[Graphics.Text.LineFillMask.LineMaskStyle, str]] = ..., width_offset: _Optional[float] = ..., horizontal_offset: _Optional[float] = ...) -> None: ...
        class GradientFill(_message.Message):
            ...
            def __init__(self, gradient: _Optional[_Union[Graphics.Gradient, _Mapping]] = ..., stretch_to_document_bounds: _Optional[bool] = ...) -> None: ...
        ...
        class ChordPro(_message.Message):
            ...
            color: _color_pb2.Color
            def __init__(self, enabled: _Optional[bool] = ..., notation: _Optional[_Union[Graphics.Text.ChordPro.Notation, str]] = ..., color: _Optional[_Union[_color_pb2.Color, _Mapping]] = ...) -> None: ...
        class Attributes(_message.Message):
            __slots__ = ("font", "capitalization", "underline_style", "underline_color", "paragraph_style", "kerning", "superscript", "strikethrough_style", "strikethrough_color", "stroke_width", "stroke_color", "custom_attributes", "background_color", "ligature_style", "text_solid_fill", "text_gradient_fill", "cut_out_fill", "media_fill", "background_effect")
            ...
            class CharacterSizeMode(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
                __slots__ = ()
                CHARACTER_SIZE_MODE_NORMAL: _ClassVar[Graphics.Text.Attributes.CharacterSizeMode]
                CHARACTER_SIZE_MODE_SCALED_BY_DOCUMENT_HEIGHT: _ClassVar[Graphics.Text.Attributes.CharacterSizeMode]
                CHARACTER_SIZE_MODE_SCALED_BY_DOCUMENT_WIDTH: _ClassVar[Graphics.Text.Attributes.CharacterSizeMode]
            CHARACTER_SIZE_MODE_NORMAL: Graphics.Text.Attributes.CharacterSizeMode
            CHARACTER_SIZE_MODE_SCALED_BY_DOCUMENT_HEIGHT: Graphics.Text.Attributes.CharacterSizeMode
            CHARACTER_SIZE_MODE_SCALED_BY_DOCUMENT_WIDTH: Graphics.Text.Attributes.CharacterSizeMode
            class LigatureStyle(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
                __slots__ = ()
                LIGATURE_STYLE_DEFAULT: _ClassVar[Graphics.Text.Attributes.LigatureStyle]
                LIGATURE_STYLE_NONE: _ClassVar[Graphics.Text.Attributes.LigatureStyle]
            LIGATURE_STYLE_DEFAULT: Graphics.Text.Attributes.LigatureStyle
            LIGATURE_STYLE_NONE: Graphics.Text.Attributes.LigatureStyle
            class Underline(_message.Message):
                ...
                by_word: bool
                def __init__(self, style: _Optional[_Union[Graphics.Text.Attributes.Underline.Style, str]] = ..., pattern: _Optional[_Union[Graphics.Text.Attributes.Underline.Pattern, str]] = ..., by_word: _Optional[bool] = ...) -> None: ...
            class Paragraph(_message.Message):
                ...
                class TextList(_message.Message):
                    ...
                    postfix: str
                    starting_number: int
                    def __init__(self, is_enabled: _Optional[bool] = ..., number_type: _Optional[_Union[Graphics.Text.Attributes.Paragraph.TextList.NumberType, str]] = ..., prefix: _Optional[str] = ..., postfix: _Optional[str] = ..., starting_number: _Optional[int] = ...) -> None: ...
                ALIGNMENT_FIELD_NUMBER: _ClassVar[int]
            ...
            class CustomAttribute(_message.Message):
                __slots__ = ("range", "capitalization", "original_font_size", "font_scale_factor", "text_gradient_fill", "should_preserve_foreground_color", "chord", "cut_out_fill", "media_fill", "background_effect", "character_size_mode", "original_font")
                ...
                ORIGINAL_FONT_FIELD_NUMBER: _ClassVar[int]
            ...
            LIGATURE_STYLE_FIELD_NUMBER: _ClassVar[int]
            ...
            ligature_style: Graphics.Text.Attributes.LigatureStyle
            text_solid_fill: _color_pb2.Color
            text_gradient_fill: Graphics.Text.GradientFill
            cut_out_fill: Graphics.Text.CutOutFill
            media_fill: Graphics.Text.MediaFill
            background_effect: Graphics.BackgroundEffect
            def __init__(self, font: _Optional[_Union[_font_pb2.Font, _Mapping]] = ..., capitalization: _Optional[_Union[Graphics.Text.Attributes.Capitalization, str]] = ..., underline_style: _Optional[_Union[Graphics.Text.Attributes.Underline, _Mapping]] = ..., underline_color: _Optional[_Union[_color_pb2.Color, _Mapping]] = ..., paragraph_style: _Optional[_Union[Graphics.Text.Attributes.Paragraph, _Mapping]] = ..., kerning: _Optional[float] = ..., superscript: _Optional[int] = ..., strikethrough_style: _Optional[_Union[Graphics.Text.Attributes.Underline, _Mapping]] = ..., strikethrough_color: _Optional[_Union[_color_pb2.Color, _Mapping]] = ..., stroke_width: _Optional[float] = ..., stroke_color: _Optional[_Union[_color_pb2.Color, _Mapping]] = ..., custom_attributes: _Optional[_Iterable[_Union[Graphics.Text.Attributes.CustomAttribute, _Mapping]]] = ..., background_color: _Optional[_Union[_color_pb2.Color, _Mapping]] = ..., ligature_style: _Optional[_Union[Graphics.Text.Attributes.LigatureStyle, str]] = ..., text_solid_fill: _Optional[_Union[_color_pb2.Color, _Mapping]] = ..., text_gradient_fill: _Optional[_Union[Graphics.Text.GradientFill, _Mapping]] = ..., cut_out_fill: _Optional[_Union[Graphics.Text.CutOutFill, _Mapping]] = ..., media_fill: _Optional[_Union[Graphics.Text.MediaFill, _Mapping]] = ..., background_effect: _Optional[_Union[Graphics.BackgroundEffect, _Mapping]] = ...) -> None: ...
        class AlternateText(_message.Message):
            __slots__ = ("key", "plain_text")
            KEY_FIELD_NUMBER: _ClassVar[int]
            PLAIN_TEXT_FIELD_NUMBER: _ClassVar[int]
            key: str
            plain_text: str
            def __init__(self, key: _Optional[str] = ..., plain_text: _Optional[str] = ...) -> None: ...
        ...
        ALTERNATE_TEXTS_FIELD_NUMBER: _ClassVar[int]
        ...
        alternate_texts: _containers.RepeatedCompositeFieldContainer[Graphics.Text.AlternateText]
        def __init__(self, attributes: _Optional[_Union[Graphics.Text.Attributes, _Mapping]] = ..., shadow: _Optional[_Union[Graphics.Shadow, _Mapping]] = ..., rtf_data: _Optional[bytes] = ..., vertical_alignment: _Optional[_Union[Graphics.Text.VerticalAlignment, str]] = ..., scale_behavior: _Optional[_Union[Graphics.Text.ScaleBehavior, str]] = ..., margins: _Optional[_Union[Graphics.EdgeInsets, _Mapping]] = ..., is_superscript_standardized: _Optional[bool] = ..., transform: _Optional[_Union[Graphics.Text.Transform, str]] = ..., transformDelimiter: _Optional[str] = ..., chord_pro: _Optional[_Union[Graphics.Text.ChordPro, _Mapping]] = ..., alternate_texts: _Optional[_Iterable[_Union[Graphics.Text.AlternateText, _Mapping]]] = ...) -> None: ...
    class PowerPointImport(_message.Message):
        ...
        width: float
        height: float
        def __init__(self, text: _Optional[_Union[Graphics.Text, _Mapping]] = ..., width: _Optional[float] = ..., height: _Optional[float] = ...) -> None: ...
    def __init__(self) -> None: ...
...
class Media(_message.Message):
    ...
    class Metadata(_message.Message):
        __slots__ = ("manufacture_name", "manufacture_url", "information", "artist", "format", "color_format")
        class ColorFormat(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
            __slots__ = ()
            COLOR_FORMAT_UNKNOWN: _ClassVar[Media.Metadata.ColorFormat]
            COLOR_FORMAT_SDR: _ClassVar[Media.Metadata.ColorFormat]
            COLOR_FORMAT_HDR_REC_2100_HLG: _ClassVar[Media.Metadata.ColorFormat]
            COLOR_FORMAT_HDR_REC_2100_PQ: _ClassVar[Media.Metadata.ColorFormat]
        COLOR_FORMAT_UNKNOWN: Media.Metadata.ColorFormat
        COLOR_FORMAT_SDR: Media.Metadata.ColorFormat
        COLOR_FORMAT_HDR_REC_2100_HLG: Media.Metadata.ColorFormat
        COLOR_FORMAT_HDR_REC_2100_PQ: Media.Metadata.ColorFormat
        ...
        artist: str
        format: str
        color_format: Media.Metadata.ColorFormat
        def __init__(self, manufacture_name: _Optional[str] = ..., manufacture_url: _Optional[_Union[_url_pb2.URL, _Mapping]] = ..., information: _Optional[str] = ..., artist: _Optional[str] = ..., format: _Optional[str] = ..., color_format: _Optional[_Union[Media.Metadata.ColorFormat, str]] = ...) -> None: ...
    class VideoDevice(_message.Message):
        __slots__ = ("type", "name", "unique_id", "model_id", "format_index", "audio_routing", "aircast")
        class Type(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
            __slots__ = ()
            ...
            TYPE_AIRCAST: _ClassVar[Media.VideoDevice.Type]
        ...
        TYPE_AIRCAST: Media.VideoDevice.Type
        class AirCast(_message.Message):
            __slots__ = ("service_name", "password", "password_enabled")
            ...
            def __init__(self, service_name: _Optional[str] = ..., password: _Optional[str] = ..., password_enabled: _Optional[bool] = ...) -> None: ...
        TYPE_FIELD_NUMBER: _ClassVar[int]
        NAME_FIELD_NUMBER: _ClassVar[int]
        ...
        AIRCAST_FIELD_NUMBER: _ClassVar[int]
        ...
        aircast: Media.VideoDevice.AirCast
        def __init__(self, type: _Optional[_Union[Media.VideoDevice.Type, str]] = ..., name: _Optional[str] = ..., unique_id: _Optional[str] = ..., model_id: _Optional[str] = ..., format_index: _Optional[int] = ..., audio_routing: _Optional[_Union[_digitalAudio_pb2.DigitalAudio.Device.Routing, _Mapping]] = ..., aircast: _Optional[_Union[Media.VideoDevice.AirCast, _Mapping]] = ...) -> None: ...
    ...
    class Audio(_message.Message):
        ...
        class Channel(_message.Message):
            ...
            def __init__(self, index: _Optional[int] = ..., muted: _Optional[bool] = ..., volume: _Optional[float] = ..., compress_limit: _Optional[bool] = ..., outputs: _Optional[_Iterable[_Union[Media.Audio.Channel.Output, _Mapping]]] = ...) -> None: ...
        def __init__(self) -> None: ...
    class AudioProperties(_message.Message):
        ...
        def __init__(self, volume: _Optional[float] = ..., audio_channels: _Optional[_Iterable[_Union[Media.Audio.Channel, _Mapping]]] = ..., is_custom_mapping: _Optional[bool] = ...) -> None: ...
    ...
    class DrawingProperties(_message.Message):
        ...
        def __init__(self, scale_behavior: _Optional[_Union[Media.ScaleBehavior, str]] = ..., is_blurred: _Optional[bool] = ..., scale_alignment: _Optional[_Union[Media.ScaleAlignment, str]] = ..., flipped_horizontally: _Optional[bool] = ..., flipped_vertically: _Optional[bool] = ..., natural_size: _Optional[_Union[Graphics.Size, _Mapping]] = ..., custom_image_rotation: _Optional[float] = ..., custom_image_bounds: _Optional[_Union[Graphics.Rect, _Mapping]] = ..., custom_image_aspect_locked: _Optional[bool] = ..., alpha_inverted: _Optional[bool] = ..., native_rotation: _Optional[_Union[Media.DrawingProperties.NativeRotationType, str]] = ..., selected_effect_preset_uuid: _Optional[_Union[_uuid_pb2.UUID, _Mapping]] = ..., effects: _Optional[_Iterable[_Union[_effects_pb2.Effect, _Mapping]]] = ..., crop_enable: _Optional[bool] = ..., crop_insets: _Optional[_Union[Graphics.EdgeInsets, _Mapping]] = ..., alpha_type: _Optional[_Union[_alphaType_pb2.AlphaType, str]] = ...) -> None: ...
    class VideoProperties(_message.Message):
        __slots__ = ("frame_rate", "field_type", "thumbnail_position", "end_behavior", "soft_loop", "soft_loop_duration", "hardware_decoding")
        ...
        class HardwareDecodingType(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
            __slots__ = ()
            HARDWARE_DECODING_TYPE_AUTOMATIC: _ClassVar[Media.VideoProperties.HardwareDecodingType]
            HARDWARE_DECODING_TYPE_DISABLED: _ClassVar[Media.VideoProperties.HardwareDecodingType]
        HARDWARE_DECODING_TYPE_AUTOMATIC: Media.VideoProperties.HardwareDecodingType
        HARDWARE_DECODING_TYPE_DISABLED: Media.VideoProperties.HardwareDecodingType
        ...
        hardware_decoding: Media.VideoProperties.HardwareDecodingType
        def __init__(self, frame_rate: _Optional[float] = ..., field_type: _Optional[_Union[Media.VideoProperties.FieldType, str]] = ..., thumbnail_position: _Optional[float] = ..., end_behavior: _Optional[_Union[Media.VideoProperties.EndBehavior, str]] = ..., soft_loop: _Optional[bool] = ..., soft_loop_duration: _Optional[float] = ..., hardware_decoding: _Optional[_Union[Media.VideoProperties.HardwareDecodingType, str]] = ...) -> None: ...
