...
class CloudVideoInput(_message.Message):
    __slots__ = ("uuid", "user_description", "thumbnail_path")
    UUID_FIELD_NUMBER: _ClassVar[int]
    USER_DESCRIPTION_FIELD_NUMBER: _ClassVar[int]
    THUMBNAIL_PATH_FIELD_NUMBER: _ClassVar[int]
    uuid: _uuid_pb2.UUID
    user_description: str
    thumbnail_path: _url_pb2.URL
    def __init__(self, uuid: _Optional[_Union[_uuid_pb2.UUID, _Mapping]] = ..., user_description: _Optional[str] = ..., thumbnail_path: _Optional[_Union[_url_pb2.URL, _Mapping]] = ...) -> None: ...

class CloudAudioInput(_message.Message):
    __slots__ = ("uuid", "user_description")
    UUID_FIELD_NUMBER: _ClassVar[int]
    USER_DESCRIPTION_FIELD_NUMBER: _ClassVar[int]
    uuid: _uuid_pb2.UUID
    user_description: str
    def __init__(self, uuid: _Optional[_Union[_uuid_pb2.UUID, _Mapping]] = ..., user_description: _Optional[str] = ...) -> None: ...
