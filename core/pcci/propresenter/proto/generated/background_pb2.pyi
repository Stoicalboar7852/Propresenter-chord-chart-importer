...
class Background(_message.Message):
    ...
    def __init__(self, is_enabled: _Optional[bool] = ..., color: _Optional[_Union[_color_pb2.Color, _Mapping]] = ..., gradient: _Optional[_Union[_graphicsData_pb2.Graphics.Gradient, _Mapping]] = ...) -> None: ...
