...
class Effect(_message.Message):
    ...
    def __init__(self, uuid: _Optional[_Union[_uuid_pb2.UUID, _Mapping]] = ..., enabled: _Optional[bool] = ..., name: _Optional[str] = ..., render_id: _Optional[str] = ..., behavior_description: _Optional[str] = ..., category: _Optional[str] = ..., variables: _Optional[_Iterable[_Union[Effect.EffectVariable, _Mapping]]] = ...) -> None: ...
