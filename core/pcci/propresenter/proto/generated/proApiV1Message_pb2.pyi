...
class API_v1_Message(_message.Message):
    __slots__ = ("id", "message", "tokens", "theme", "visible_on_network", "is_active")
    class API_v1_MessageToken(_message.Message):
        __slots__ = ("uuid", "name", "text", "timer", "clock")
        ...
        class API_v1_ClockToken(_message.Message):
            ...
            is_24_hours: bool
            def __init__(self, date: _Optional[_Union[API_v1_Message.API_v1_MessageToken.API_v1_ClockToken.API_v1_ClockTokenFormat, str]] = ..., time: _Optional[_Union[API_v1_Message.API_v1_MessageToken.API_v1_ClockToken.API_v1_ClockTokenFormat, str]] = ..., is_24_hours: _Optional[bool] = ...) -> None: ...
        ...
        def __init__(self, uuid: _Optional[str] = ..., name: _Optional[str] = ..., text: _Optional[_Union[API_v1_Message.API_v1_MessageToken.API_v1_TextToken, _Mapping]] = ..., timer: _Optional[_Union[API_v1_Message.API_v1_MessageToken.API_v1_TimerToken, _Mapping]] = ..., clock: _Optional[_Union[API_v1_Message.API_v1_MessageToken.API_v1_ClockToken, _Mapping]] = ...) -> None: ...
    ID_FIELD_NUMBER: _ClassVar[int]
    ...
    is_active: bool
    def __init__(self, id: _Optional[_Union[_proApiV1Identifier_pb2.API_v1_Identifier, _Mapping]] = ..., message: _Optional[str] = ..., tokens: _Optional[_Iterable[_Union[API_v1_Message.API_v1_MessageToken, _Mapping]]] = ..., theme: _Optional[_Union[_proApiV1Identifier_pb2.API_v1_Identifier, _Mapping]] = ..., visible_on_network: _Optional[bool] = ..., is_active: _Optional[bool] = ...) -> None: ...
...
class API_v1_Message_Request(_message.Message):
    ...
    class TriggerMessage(_message.Message):
        __slots__ = ("id", "tokens", "requires_confirmation")
        ID_FIELD_NUMBER: _ClassVar[int]
        TOKENS_FIELD_NUMBER: _ClassVar[int]
        ...
        def __init__(self, id: _Optional[str] = ..., tokens: _Optional[_Iterable[_Union[API_v1_Message.API_v1_MessageToken, _Mapping]]] = ..., requires_confirmation: _Optional[bool] = ...) -> None: ...
