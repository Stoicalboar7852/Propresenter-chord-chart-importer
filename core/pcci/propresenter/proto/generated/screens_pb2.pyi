...
class Screen(_message.Message):
    ...
    def __init__(self, uuid: _Optional[_Union[_uuid_pb2.UUID, _Mapping]] = ..., name: _Optional[str] = ..., color: _Optional[_Union[_color_pb2.Color, _Mapping]] = ..., bounds: _Optional[_Union[_graphicsData_pb2.Graphics.Rect, _Mapping]] = ..., aspect_ratio_locked: _Optional[bool] = ..., output_bounds_aspect_ratio_locked: _Optional[bool] = ..., corner_pinning_enabled: _Optional[bool] = ..., subscreen_unit_rect: _Optional[_Union[_graphicsData_pb2.Graphics.Rect, _Mapping]] = ..., rotation: _Optional[float] = ..., gamma: _Optional[float] = ..., black_level: _Optional[float] = ..., blended_edges: _Optional[int] = ..., corner_values: _Optional[_Union[CornerValues, _Mapping]] = ..., output_display: _Optional[_Union[OutputDisplay, _Mapping]] = ..., color_enabled: _Optional[bool] = ..., color_adjustment: _Optional[_Union[Screen.ColorAdjustment, _Mapping]] = ..., blend_compensation: _Optional[_Union[Screen.BlendCompensation, _Mapping]] = ..., alpha_settings: _Optional[_Union[Screen.AlphaSettings, _Mapping]] = ...) -> None: ...
...
class DisplayMode(_message.Message):
    ...
    refresh_rate: float
    interlaced: bool
    def __init__(self, name: _Optional[str] = ..., width: _Optional[int] = ..., height: _Optional[int] = ..., refresh_rate: _Optional[float] = ..., interlaced: _Optional[bool] = ...) -> None: ...

class OutputDisplay(_message.Message):
    __slots__ = ("name", "model", "serial", "deviceName", "vendor", "modeIndex", "bounds", "type", "mode", "render_id", "video_delay", "render_format", "hdr_max_nits_offset", "blackmagic")
    ...
    class RenderFormat(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
        __slots__ = ()
        RENDERFORMAT_SDR: _ClassVar[OutputDisplay.RenderFormat]
        RENDERFORMAT_REC_2100_PQ: _ClassVar[OutputDisplay.RenderFormat]
        RENDERFORMAT_REC_2100_HLG: _ClassVar[OutputDisplay.RenderFormat]
    RENDERFORMAT_SDR: OutputDisplay.RenderFormat
    RENDERFORMAT_REC_2100_PQ: OutputDisplay.RenderFormat
    RENDERFORMAT_REC_2100_HLG: OutputDisplay.RenderFormat
    class Blackmagic(_message.Message):
        ...
        blend_value: float
        def __init__(self, enabled: _Optional[bool] = ..., key_mode: _Optional[_Union[OutputDisplay.Blackmagic.KeyMode, str]] = ..., blend_value: _Optional[float] = ...) -> None: ...
    NAME_FIELD_NUMBER: _ClassVar[int]
    ...
    RENDER_FORMAT_FIELD_NUMBER: _ClassVar[int]
    HDR_MAX_NITS_OFFSET_FIELD_NUMBER: _ClassVar[int]
    ...
    render_id: str
    video_delay: int
    render_format: OutputDisplay.RenderFormat
    hdr_max_nits_offset: int
    blackmagic: OutputDisplay.Blackmagic
    def __init__(self, name: _Optional[str] = ..., model: _Optional[str] = ..., serial: _Optional[str] = ..., deviceName: _Optional[str] = ..., vendor: _Optional[str] = ..., modeIndex: _Optional[int] = ..., bounds: _Optional[_Union[_graphicsData_pb2.Graphics.Rect, _Mapping]] = ..., type: _Optional[_Union[OutputDisplay.Type, str]] = ..., mode: _Optional[_Union[DisplayMode, _Mapping]] = ..., render_id: _Optional[str] = ..., video_delay: _Optional[int] = ..., render_format: _Optional[_Union[OutputDisplay.RenderFormat, str]] = ..., hdr_max_nits_offset: _Optional[int] = ..., blackmagic: _Optional[_Union[OutputDisplay.Blackmagic, _Mapping]] = ...) -> None: ...
