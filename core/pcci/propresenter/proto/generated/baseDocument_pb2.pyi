...
class Document(_message.Message):
    ...
    def __init__(self, application_info: _Optional[_Union[_applicationInfo_pb2.ApplicationInfo, _Mapping]] = ..., uuid: _Optional[_Union[_uuid_pb2.UUID, _Mapping]] = ..., uses_relative_urls: _Optional[bool] = ..., workspace: _Optional[_Union[_workspace_pb2.Workspace, _Mapping]] = ...) -> None: ...
...
class PVPDocumentState(_message.Message):
    ...
    def __init__(self, primary_playlist: _Optional[_Union[PVPDocumentState.PlaylistState, _Mapping]] = ..., alternate_playlist: _Optional[_Union[PVPDocumentState.PlaylistState, _Mapping]] = ..., playlist_split_is_vertical: _Optional[bool] = ..., targeted_layer: _Optional[_Union[_uuid_pb2.UUID, _Mapping]] = ..., selected_layer: _Optional[_Union[_uuid_pb2.UUID, _Mapping]] = ..., locked_layer: _Optional[_Union[_uuid_pb2.UUID, _Mapping]] = ..., live_video_playlist_scale: _Optional[float] = ..., split_view_divider_position: _Optional[float] = ...) -> None: ...
