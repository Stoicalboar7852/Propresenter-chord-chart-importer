...
class Recording(_message.Message):
    ...
    class Stream(_message.Message):
        ...
        class Encoder(_message.Message):
            ...
            video_bitrate: int
            audio_bitrate: int
            def __init__(self, codec: _Optional[_Union[Recording.Stream.Codec, str]] = ..., video_width: _Optional[int] = ..., video_height: _Optional[int] = ..., is_interlaced: _Optional[bool] = ..., frameRate: _Optional[_Union[Recording.Stream.FrameRate, str]] = ..., video_bitrate: _Optional[int] = ..., audio_bitrate: _Optional[int] = ...) -> None: ...
        ...
        def __init__(self, id: _Optional[_Union[_uuid_pb2.UUID, _Mapping]] = ..., encoder: _Optional[_Union[Recording.Stream.Encoder, _Mapping]] = ..., destinations: _Optional[_Iterable[_Union[Recording.Stream.Destination, _Mapping]]] = ..., audio_map: _Optional[_Iterable[_Union[_digitalAudio_pb2.DigitalAudio.Device.Map, _Mapping]]] = ..., isAudioCustomMapped: _Optional[bool] = ..., output_screen: _Optional[_Union[Recording.Stream.OutputScreenSource, _Mapping]] = ...) -> None: ...
