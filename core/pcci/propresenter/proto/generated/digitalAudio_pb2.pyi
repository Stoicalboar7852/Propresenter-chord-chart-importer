...
class DigitalAudio(_message.Message):
    ...
    class Setup(_message.Message):
        ...
        def __init__(self, buses: _Optional[_Iterable[_Union[DigitalAudio.Bus, _Mapping]]] = ..., monitor_device: _Optional[_Union[DigitalAudio.Device, _Mapping]] = ..., main_output_device: _Optional[_Union[DigitalAudio.Device, _Mapping]] = ..., enable_sdi_ndi_device: _Optional[bool] = ..., sdi_ndi_device: _Optional[_Union[DigitalAudio.Device, _Mapping]] = ..., monitor_on_mains: _Optional[bool] = ..., disable_main_output_device: _Optional[bool] = ...) -> None: ...
    class Bus(_message.Message):
        ...
        test_tone: bool
        master_level: float
        def __init__(self, name: _Optional[str] = ..., muted: _Optional[bool] = ..., solo: _Optional[bool] = ..., test_tone: _Optional[bool] = ..., master_level: _Optional[float] = ...) -> None: ...
    class Device(_message.Message):
        ...
        class Channel(_message.Message):
            ...
            audio_delay: float
            level: float
            def __init__(self, mute_enable: _Optional[bool] = ..., solo_enable: _Optional[bool] = ..., tone_enable: _Optional[bool] = ..., audio_delay: _Optional[float] = ..., level: _Optional[float] = ...) -> None: ...
        class Routing(_message.Message):
            ...
            def __init__(self, channels: _Optional[_Iterable[_Union[DigitalAudio.Device.Channel, _Mapping]]] = ..., map: _Optional[_Iterable[_Union[DigitalAudio.Device.Map, _Mapping]]] = ..., is_custom_map: _Optional[bool] = ..., master_channel: _Optional[_Union[DigitalAudio.Device.Channel, _Mapping]] = ...) -> None: ...
        NAME_FIELD_NUMBER: _ClassVar[int]
