...
class TimedPlayback(_message.Message):
    ...
    class Sequence(_message.Message):
        __slots__ = ("sequence", "content_destination", "presentation", "playlist")
        ...
        def __init__(self, sequence: _Optional[_Iterable[_Union[TimedPlayback.Sequence.SequenceItem, _Mapping]]] = ..., content_destination: _Optional[_Union[_action_pb2.Action.ContentDestination, str]] = ..., presentation: _Optional[_Union[_presentation_pb2.Presentation, _Mapping]] = ..., playlist: _Optional[_Union[_playlist_pb2.Playlist, _Mapping]] = ...) -> None: ...
    class Timing(_message.Message):
        ...
        class Internal(_message.Message):
            ...
            duration: float
            should_loop: bool
            def __init__(self, duration: _Optional[float] = ..., should_loop: _Optional[bool] = ...) -> None: ...
    ...
    class Update(_message.Message):
        ...
        class Record(_message.Message):
            ...
            is_recording: bool
            def __init__(self, is_recording: _Optional[bool] = ...) -> None: ...
        ...
        class Loop(_message.Message):
            ...
            loop: bool
            def __init__(self, loop: _Optional[bool] = ...) -> None: ...
