...
class UserFeedback(_message.Message):
    ...
    class ApplicationMetadata(_message.Message):
        __slots__ = ("application_version", "os_version", "application_instances", "blackmagic_desktop_video_instances", "screens", "crash_reporting_enabled", "analytics_reporting_enabled", "enabled_feature_flags", "organization_id")
