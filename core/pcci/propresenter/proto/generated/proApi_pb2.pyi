...
class AirplayConfiguration(_message.Message):
    __slots__ = ("enable", "fairplay_path", "service_name", "password", "password_enabled", "uuid")
    ENABLE_FIELD_NUMBER: _ClassVar[int]
    FAIRPLAY_PATH_FIELD_NUMBER: _ClassVar[int]
    ...
    uuid: str
    def __init__(self, enable: _Optional[bool] = ..., fairplay_path: _Optional[str] = ..., service_name: _Optional[str] = ..., password: _Optional[str] = ..., password_enabled: _Optional[bool] = ..., uuid: _Optional[str] = ...) -> None: ...

class ProApiNetworkConfiguration(_message.Message):
    __slots__ = ("enable_network", "port", "network_name", "remote_enable", "remote_control_enable", "remote_control_password", "remote_observe_enable", "remote_observe_password", "stage_enable", "stage_password", "link_enable", "web_resource_root", "tcp_stream_port", "tcp_stream_enable", "airplay", "proremote_websocket_enable", "proremote_websocket_password")
    ...
    AIRPLAY_FIELD_NUMBER: _ClassVar[int]
    PROREMOTE_WEBSOCKET_ENABLE_FIELD_NUMBER: _ClassVar[int]
    PROREMOTE_WEBSOCKET_PASSWORD_FIELD_NUMBER: _ClassVar[int]
    enable_network: bool
    port: int
    network_name: str
    remote_enable: bool
    ...
    airplay: AirplayConfiguration
    proremote_websocket_enable: bool
    proremote_websocket_password: str
    def __init__(self, enable_network: _Optional[bool] = ..., port: _Optional[int] = ..., network_name: _Optional[str] = ..., remote_enable: _Optional[bool] = ..., remote_control_enable: _Optional[bool] = ..., remote_control_password: _Optional[str] = ..., remote_observe_enable: _Optional[bool] = ..., remote_observe_password: _Optional[str] = ..., stage_enable: _Optional[bool] = ..., stage_password: _Optional[str] = ..., link_enable: _Optional[bool] = ..., web_resource_root: _Optional[str] = ..., tcp_stream_port: _Optional[int] = ..., tcp_stream_enable: _Optional[bool] = ..., airplay: _Optional[_Union[AirplayConfiguration, _Mapping]] = ..., proremote_websocket_enable: _Optional[bool] = ..., proremote_websocket_password: _Optional[str] = ...) -> None: ...

class ProNetworkConfigurationMessage(_message.Message):
    __slots__ = ("configuration", "restart_network", "shutdown")
    class RestartNetwork(_message.Message):
        __slots__ = ()
    ...
    RESTART_NETWORK_FIELD_NUMBER: _ClassVar[int]
    SHUTDOWN_FIELD_NUMBER: _ClassVar[int]
    configuration: ProApiNetworkConfiguration
    restart_network: ProNetworkConfigurationMessage.RestartNetwork
    shutdown: ProNetworkConfigurationMessage.Shutdown
    def __init__(self, configuration: _Optional[_Union[ProApiNetworkConfiguration, _Mapping]] = ..., restart_network: _Optional[_Union[ProNetworkConfigurationMessage.RestartNetwork, _Mapping]] = ..., shutdown: _Optional[_Union[ProNetworkConfigurationMessage.Shutdown, _Mapping]] = ...) -> None: ...
...
class ProLink(_message.Message):
    ...
    class HandlerIn(_message.Message):
        ...
        class ServerState(_message.Message):
            ...
            def __init__(self, local_ip: _Optional[str] = ..., public_ip: _Optional[str] = ..., port: _Optional[int] = ..., success: _Optional[bool] = ..., tcp_stream_port: _Optional[int] = ..., tcp_stream_success: _Optional[bool] = ...) -> None: ...
    ...
    class HandlerOut(_message.Message):
        ...
        class GroupJoinConfirmation(_message.Message):
            ...
            ACCEPT_FIELD_NUMBER: _ClassVar[int]
            accept: bool
            def __init__(self, accept: _Optional[bool] = ...) -> None: ...
        class GroupJoinPassword(_message.Message):
            __slots__ = ("password",)
            PASSWORD_FIELD_NUMBER: _ClassVar[int]
            password: str
...
class NetworkAPI(_message.Message):
    ...
    class Action(_message.Message):
        ...
        class API_PrerollComplete(_message.Message):
            ...
            failed: bool
            latency: int
            def __init__(self, id: _Optional[int] = ..., failed: _Optional[bool] = ..., latency: _Optional[int] = ...) -> None: ...
